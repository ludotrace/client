...
func TestUpload_202(t *testing.T) {
	...
	jobID, err := Upload(context.Background(), srv.URL, "fallout4", filePath, "tok")
	if err != nil {
...
func TestUpload_401(t *testing.T) {
	...
	_, err := Upload(context.Background(), srv.URL, "fallout4", filePath, "bad")
...
func TestUpload_ContextCancelDuringBackoff(t *testing.T) {
	...
	_, err := Upload(ctx, srv.URL, "fallout4", filePath, "tok")
